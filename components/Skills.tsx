...
export default function Skills({ skills }: { skills: SkillType[] }) {
  ...
  return (
    <section id="skills" className="min-h-[100dvh] w-full flex items-center border-t border-border bg-background snap-start snap-always">
      <div className="w-full mx-auto max-w-[1100px] px-6 py-20">
        ...
        <div className="mt-12 flex flex-col md:flex-row items-start gap-8 md:gap-12">
                ...
                >
                  <HoverCard.Trigger asChild>
                    <button
                      ...
                      className="cursor-pointer border border-border/60 bg-transparent px-3.5 py-1.5 text-sm text-foreground transition-all hover:border-foreground hover:bg-transparent focus:outline-none"
                    >
                      {skillName}
                    </button>
                  </HoverCard.Trigger>
                  ...
                  {skillDesc && (
                    <HoverCard.Portal>
                      <HoverCard.Content
                        className="z-[100] w-64 rounded-md border border-border bg-background/80 p-4 backdrop-blur-md animate-in fade-in-0 zoom-in-95 duration-300 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=top]:slide-in-from-bottom-2"
                        side="top"
                        sideOffset={12}
                      >
          ...
          <div className="w-full md:flex-1 pt-6 md:pt-0 min-h-[140px]">
            <div
              className="w-full md:max-w-sm rounded border border-border/60 bg-transparent px-6 flex flex-col justify-center transition-all duration-300 ease-in-out relative overflow-hidden mx-auto md:mx-0"
